...
import com.vital.codeutil.IVerifyCodeGen;
import com.vital.codeutil.SimpleCharVerifyCodeGenImpl;
import com.vital.codeutil.VerifyCode;
import com.vital.po.Admin;
import com.vital.po.ReaderCard;
import com.vital.service.AdminService;
import com.vital.service.ReaderService;
...
//            LOGGER.info("", e);
    ...
    public String loginIn(HttpServletRequest request, Model model) {
        ...
        if (realCode == null || code == null) return "login";
